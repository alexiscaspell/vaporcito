...
angular.module('vaporcito.core')
    .service('Events', ['$http', '$rootScope', '$timeout', function ($http, $rootScope, $timeout) {
        ...
        function successFn(data) {
            // When Vaporcito restarts while the long polling connection is in
        ...
        angular.extend(self, {
            ...
            // emitted by vaporcito process

            CONFIG_SAVED: 'ConfigSaved',   // Emitted after the config has been saved by the user or by Vaporcito itself
            ...
            ITEM_FINISHED: 'ItemFinished',   // Generated when Vaporcito ends synchronizing a file to a newer version
            ITEM_STARTED: 'ItemStarted',   // Generated when Vaporcito begins synchronizing a file to a newer version
            ...
            STARTING: 'Starting',   // Emitted exactly once, when Vaporcito starts, before parsing configuration etc
            STARTUP_COMPLETED: 'StartupCompleted',   // Emitted exactly once, when initialization is complete and Vaporcito is ready to start exchanging data with other devices
