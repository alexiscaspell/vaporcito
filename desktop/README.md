...
Shell nativo que arranca el motor Go (Vaporcito/Vaporcito) como **sidecar** y muestra la GUI web en un WebView.
...
Esto deja archivos en `src-tauri/binaries/` con el sufijo de target triple que exige Tauri, por ejemplo:
...
- No reescribe el front AngularJS: reutiliza la GUI embebida del binario Go.
...
- Expo no aplica a este stack; Tauri es el equivalente desktop ligero.
